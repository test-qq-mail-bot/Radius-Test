...
# 中文释义表体量较大，已拆到 describe.py（单文件 ≤20KB 约束）；
# 此处再导出，保持 from ..authorization.authz import describe_attribute 旧路径可用。
from .describe import describe_attribute  # noqa: F401
